...
down_revision: Union[str, None] = '27f64c192856'
...
def downgrade() -> None:
    ...
    sa.Column('experiencia', sa.VARCHAR(length=45), server_default=sa.text('0'), autoincrement=False, nullable=False),
